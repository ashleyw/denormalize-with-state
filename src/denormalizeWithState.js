...
export const denormalizeWithState = (entity: Entity, entities: Object, schema: Object, mappings: Object) : Denormalized => {
  ...
  if (typeof entity === 'number' || typeof entity === 'string') {
    ...
    if (Array.isArray(entity)) {
      ...
      }).sort((e1, e2) => e1._order - e2._order).map((e) => { delete e._order; return e; });
    }
  }
